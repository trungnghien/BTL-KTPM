<%-- 
    Document   : header
    Created on : Nov 11, 2018, 4:20:13 PM
    Author     : HaKiet
--%>
...
<html>
    ...
    <body>
        ...
        <header class="header dark-bg" style="background-color: rgba(0, 0, 0, 0.34);">
            ...
            <!--logo start-->
            <a href="indexAdmin.jsp" class="logo">Quản Lý Nhân Sự <span class="lite">Và Tiền Lương</span></a>
            <!--logo end-->
                ...
                <ul class="nav pull-right top-menu">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu extended logout">
                            ...
                            <li>
                                <a href="XuLyDangXuat"><i class="icon_key_alt"></i>Thoát</a>
                            </li>
                            <li>
